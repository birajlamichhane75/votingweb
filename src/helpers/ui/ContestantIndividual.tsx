...
import { GetCandidatesByID, GetCandidatesByVotingCamapign } from '../redux/candidates/_thunks';
...
const ContestantProfile: React.FC<{ params: string }> = ({ params }) => {
  ...
  async function getXApiKey() {
    ...
    const response = await axios.get('https://voting-identity.intersexnepal.org/v1/x-api-key/' + orgID)
  ...
  const { candidates_by_id_data } = useAppSelector((state: RootState) => state.Candidates);
          ...
          <section className="Candidate-Individulal -has-candidate-info -is-valid-by-id">
            ...
            <div className='container mx-auto'>
              ...
              {/* <div className="flex flex-col gap-5 mx-auto">
                  ...
                  <div>
                    {contestant.votingStageCandidates.length > 0 && <p className="profile-topic">Vote in</p> }
                    <div className="flex flex-wrap">
                      {
                        contestant.votingStageCandidates.map((stageCandidate : VotingStageCandidate , index : number) =>{
                          return(
                            <div className='w-full md:w-1/3' key={index}>
                              ...
                              startDateTime={stageCandidate.votingCampaignStage.startDateTime}
                              endDateTime={stageCandidate.votingCampaignStage.endDateTime}
                              />
                            </div>
                          )
                        })
              ...
              <div className="flex md:flex-row flex-col gap-[1.5rem] py-[2rem]">
                <div className="w-[25%]">

                  <div className='w-full h-[25rem] rounded-md overflow-hidden'>
                    <Image src={process.env.NEXT_PUBLIC_AWS_URI + contestant.profilePicture} height={500} width={900} alt="profile"
                ...
                <div className="w-[75%] shadow-lg border-1 border-[var(--border-color)] rounded-md py-[1.5em] px-[1.5rem] flex flex-col gap-[1rem]">
                  <header>
                    <h1 className='text-[2rem] font-[600] text-[var(--black)] font-poppins'>Profile</h1>
                  </header>

                  <div className='flex flex-col gap-[2rem] w-full'>
                    <section className='grid grid-cols-3 gap-[1rem] gap-y-[1.5rem]'>
                      <div className='profile-input-box'>
                        <label className='contestant-profile-title'>Full Name</label>
                        <p className='contestant-profile-info'>{contestant.name}</p>
                      </div>

                      <div className='profile-input-box'>
                        <label className='contestant-profile-title'>Age</label>
                        <p className='contestant-profile-info'>{contestant.age}</p>
                      </div>

                      <div className='profile-input-box'>
                        <label className='contestant-profile-title'>Place Of Birth</label>
                        <p className='contestant-profile-info'>{contestant.city}</p>
                      </div>

                      <div className='profile-input-box'>
                        <label className='contestant-profile-title'>Email Address</label>
                        <p className='contestant-profile-info'>info@example.com</p>
                      </div>

                      <div className='profile-input-box'>
                        <label className='contestant-profile-title'>Nationality</label>
                        <p className='contestant-profile-info'>{contestant.nationality}</p>
                      </div>

                      <div className='profile-input-box'>
                        <label className='contestant-profile-title'>Hometown</label>
                        <p className='contestant-profile-info'>{contestant.city}</p>
                      </div>
                    ...
                    <section>
                      <div className='profile-input-box'>
                        <label className='contestant-profile-title'>About Me</label>
                    ...
                    <section className='grid grid-cols-2 gap-[1rem]'>
                      <div className='profile-input-box'>
                        <label className='contestant-profile-title'>Eye Color</label>
                        <ColorSelector color={"#130102"} colorlist={['#220202', '#130101', '#130102', '#13394F']} />
                      </div>

                      <div className='profile-input-box'>
                        <label className='contestant-profile-title'>Hair Color</label>
                        <ColorSelector color={"#13394F"} colorlist={['#220202', '#130101', '#130102', '#13394F']} />
                      </div>
                    </section>
                    ...
                    <section>
                      <div className='flex flex-col gap-[1rem]'>
                        <div>
                          <label className='contestant-profile-title'>Native Language</label>
                          <p className='contestant-profile-info'>English</p>
                        </div>

                        <div>
                          <label className='contestant-profile-title'>Additional Language</label>
                          <ul>
                            <li>English</li>
                            <li>Nepali</li>
                          </ul>
                        ...
                        <div className='flex gap-[1rem] w-[110rem] py-[1rem]'>
                          {
                            Array.from({ length: 8 }).map((_, index) => {
                              return <div key={index} className='h-[15rem] w-[25rem] rounded-md overflow-hidden'>
                                <Image src="/image/dymmy-profile.jpg" height={500} width={900} alt='profile' className='w-full h-full object-cover' />
                              </div>
                            })
                          }
                    ...
                    <section>
                      <div>
                        ...
                        <div className='grid grid-cols-3 gap-[1rem]'>
                          <div className='profile-input-box'>
                            <label className='contestant-profile-title'>Education Level</label>
                            <p className='contestant-profile-info'>Bachelor</p>
                          </div>
                          <div className='profile-input-box'>
                            <label className='contestant-profile-title'>Collage / University</label>
                            <p className='contestant-profile-info'>ABC University</p>
                          </div>
                          <div className='profile-input-box'>
                            <label className='contestant-profile-title'>Major Study</label>
                            <p className='contestant-profile-info'>Computer Science</p>
                          </div>
                        </div>
                    ...
                    <section>
                      <div className='profile-input-box'>
                        <label className='contestant-profile-title'>Academic Achievement</label>

                        <div className='flex gap-[1rem] border-2 border-var(--border-color) px-[1rem] py-[1rem] rounded-md'>
                          <div className='border-1 border-[var(--grey)] bg-[var(--light-text-color2)] px-[1.3rem] py-[.1rem] rounded-[2rem]'>Achievement 1</div>
                          <div className='border-1 border-[var(--grey)] bg-[var(--light-text-color2)] px-[1.3rem] py-[.1rem] rounded-[2rem]'>Achievement 2</div>
                          <div className='border-1 border-[var(--grey)] bg-[var(--light-text-color2)] px-[1.3rem] py-[.1rem] rounded-[2rem]'>Achievement 3</div>
