...
import { GTKBanner, GTKBannerALT } from '@/utils/image/image';
...
const GetToKnow  : React.FC = () => {
    return (
        <>
            <CommonSection name='gettoknow'>
                <section className='flex md:flex-row flex-col gap-[4rem] md:gap-[1rem] w-full py-[3rem] border-t-2'>
                    <div className='md:w-[50%] w-full relative'>
                        ...
                        <Image src={GTKBannerALT} width={800} height={800} alt='gtk-banner'
                    ...
                    <div className='md:w-[50%] w-full flex flex-col items-start gap-[1rem]'>
                        ...
                        <div>
                            <button className='round-btn'>Read More</button>
                        </div>
