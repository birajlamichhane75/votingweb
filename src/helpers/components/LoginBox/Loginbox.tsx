...
const LoginBox : React.FC = () => {1
    ...
    const submitHandler = async(e: React.MouseEvent<HTMLButtonElement>) : Promise<void> => {
        ...
        try{
            ...
            const response = await dataService.postData('/users/login',{email,password});
            if(response.success){
                ...
                if(user.isVerified){
                    ...
                    const sendOtpResponse = await dataService.getData('users/send-verification-token');
        ...
        <>
            <form className='px-[20px] md:px-[47px] w-[unset] md:w-[24rem] py-1 box-content mx-auto'>
                <div className="text-center flex flex-col justify-start w-[100%] mx-auto items-center">
                    <h2 className="text-[var(--c-secondary)] text-[22px] md:text-[1.4rem] font-bold">Welcome To
                     <span className='text-[var(--c-primary)] text-[22px] md:text-[1.4rem] font-secular font-500 ml-2'>FDAPP</span>
                    </h2>
                    <p className='card-desc text-[18px] mt-[10px]'>Platform to support & Explore different Voting Campaigns</p>
                </div>
                ...
                <div className="flex flex-col gap-2 justify-center items-center w-full mt-[25px]">
                    <div className="w-full">
                        ...
                        <input
                            ...
                            className={`input-box text-[14px] focus:outline-none focus:border-blue-500 ${error ? 'error' : ''}`} />
                        {
                            error && !email && <span><p className='text-red-600 text-sm'>You have to enter vaid Email!</p></span>
                        }
                    </div>
                    ...
                    <div className="w-full relative" x-data="{show : true}">
                        ...
                        <div className='relative'>
                            <input
                                ...
                                type={isPasswordVisible ? 'text' : 'password'} placeholder="XXXXXXX"
                                className={`input-box text-[14px] focus:outline-none focus:border-blue-500 ${error ? 'error' : ''}`}/>
                            <button
                        ...
                        {
                            error && !password && <span><p className='text-red-600 text-sm'>You have to enter vaid password!</p></span>
                        }
                    </div>
                    ...
                    <div className='flex justify-between items-center w-full'>
                        <div className="flex space-x-2">
                            ...
                            <h3 className="text-sm font-semibold -mt-1 cursor-pointer">Remember Me</h3>
                        </div>
                        <Link href="/forget-password/otp/send" className="text-sm font-medium text-[var(--blue)]">Forgot Password ?</Link>
                    </div>
                ...
                <div className="text-center mt-4">
                    <button
                        ...
                        type='submit'
                        className="btn py-4">Login</button>
                </div>
                ...
                <div className="text-center flex flex-col">
                    ...
                    <div className='flex justify-center items-center gap-2 my-4'>
                        ...
                        <p className='font-bold'>or</p><span className='w-full h-[1.5px] bg-slate-200'>
                        </span>
                    </div>
                    <div className="text-center mb-7 mx-auto w-full">
                        <button
                            ...
                            <span><FcGoogle /></span><p>Continue With Google</p></button>
                    </div>
