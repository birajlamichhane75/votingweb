...
// redux imports
import { RootState, useAppSelector, useAppDispatch } from '@/helpers/hooks/useStoreHooks';
import { GetAllCampaigns, GetUpcommingCampaign } from '@/helpers/redux/voting-campaign/_thunks';
import { GetAllCandidates} from '@/helpers/redux/candidates/_thunks';
import { GetActiveCampaignStages, GetAllCampaignsStages, GetUpcommingCampaignStages } from '@/helpers/redux/voting-campaign-stages.ts/_thunks';
...
const Navbar = () => {
    ...
    // redux declaration
    const {token , user , x_api_key} : AuthState = useAppSelector((state: RootState) => state.Auth);
    ...
    return (
        <>
            <div className={`sticky top-0 w-full bg-[--c-l-primary] font-ubuntu font-[400] text-[22px] z-50 `}>
                        ...
                        <div className='container mx-auto flex items-center justify-between'>
                            <Link href="/">
                                <div className="flex items-center justify-center relative">
                                    <Image src={image} alt='' width={500} height={500} className=" h-[30px] w-[100px]"></Image>
                                </div>
                            </Link>
                            <nav className="lg:flex items-center gap-20 hidden navbar">
                                <ul className="flex items-center">
                                    <li className='px-[0.6em]'>
                                        <Link href="/" className = 'text-[var(--c-grey)] hover:text-[#fff] text-[16px] font-[500]'>
                                            Home
                                        </Link>
                                    </li>

                                    <li className='px-[0.6em]'>
                                        <Link href="/campaign" className='text-[var(--c-grey)] hover:text-[#fff] text-[16px] font-[500]'>
                                            Campaign
                                        </Link>
                                    </li>
                                    <li className='px-[0.6em]'>
                                        <Link href="/contestants"className='text-[var(--c-grey)] hover:text-[#fff] text-[16px] font-[500]'>
                                            Contestants
                                        </Link>
                                    </li>
                                    {/* <li className='px-[0.6em]'>
                                    ...
                                    <li className='px-[0.6em]'>
                                        <Link href='/about' className='text-[var(--c-grey)] hover:text-[#fff] text-[16px] font-[500]'>
                                            About Us
                                        </Link>

                                    </li>
                                    <li className='px-[0.6em]'>
                                        <Link href="/contact" className='text-[var(--c-grey)] hover:text-[#fff] text-[16px] font-[500]'>
                                            Contact Us
                                        </Link>
                                    </li>
                                </ul>
                            ...
                            <div className="lg:hidden  flex items-center gap-[9px] justify-center">
                                ...
                                >
                                    <ul className="flex items-center flex-col">
                                        <li>
                                            <Link href="/" className='text-[var(--c-grey)] text-[20px] text-[600]'  >Home</Link></li>

                                        <li>
                                            <Link href="/campaign" className='text-[var(--c-grey)] text-[20px] text-[600]'>Campaign</Link>
                                        </li>
                                        <li>
                                            <Link href="/contestants" className='text-[var(--c-grey)] text-[20px] text-[600]'>Contestants</Link>
                                        </li>
                                        {/* <li>
                                            <Link href="/pricing" className='text-[var(--c-grey)] text-[20px] text-[600]'>Pricing</Link>
                                        </li> */}
                                        <li>
                                            <Link href="/about" className='text-[var(--c-grey)] text-[20px] text-[600]'>About us</Link>
                                        </li>
                                        <li>
                                            <Link href="/contact" className='text-[var(--c-grey)] text-[20px] text-[600]'>Contact Us</Link>
                                        </li>
                                    </ul>
                                    <div className='mt-[30px]'>
                                        <Link href="/">
                                            <div className="flex items-center justify-center  relative">
                                                <Image src={image} alt='' width={500} height={500} className="object-contain h-[50px] w-[100px]"></Image>
                                            </div>
                                        </Link>
                                    </div>
                                </Drawer>
