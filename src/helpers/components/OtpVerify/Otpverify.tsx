...
const OTPverify : React.FC = () => {
    ...
    const submitHandler = async (e: React.MouseEvent<HTMLButtonElement>) : Promise<void> => {
        ...
        try{
            ...
            const response = await dataService.patchData('/users/verify',{OTP : ArrayOTPtoString})
            if(response.error){
                ...
                <div className="px-16 py-5 shadow-lg rounded-md border-2 w-[30rem]">
                    ...
                    <form>
                        ...
                        <div className='w-full text-center mt-5'>
                            <span className='w-[70%] mx-auto'>Did not recieve code? <br/> <Link href='/otp/send' className='text-[#1075B8]'>Resend Code</Link> </span>
                        </div>
                    </form>
